        ...
        <div className="container header-wraper">
          ...
          <nav className="navbar-sec navbar navbar-expand-lg navbar-light px-4 py-3 justify-content-between align-items-center">
            ...
            <Link className="navbar-brand" to="/">
              <img
                src="/media/images/ppm infotech svg.svg"
                alt="header-logo"
                loading="lazy"
              />
            </Link>
              ...
              <div className="collapse navbar-collapse " id="navbarMenu">
                <ul className="navbar-nav mx-auto">
                  <li className="nav-item">
                    <NavLink to="/" end className="nav-link" href="#">
                      Home
                    </NavLink>
                  </li>
                  <li className="nav-item">
            ...
            <div className="nav-right-btn-sec d-flex justify-content-end align-items-center">
              ...
              <button
                id="sidebar-menu-btn"
                className="sidebar-menu-btn ms-3 "
                onClick={() => setIsOpen(true)}
              >
                <img
                  className="menu-dark"
                  src="/media/icons/menu-dark-icon.png"
                  alt="Menu-icon"
                  loading="lazy"
                />
                <img
                  className="menu-light"
                  src="/media/icons/menu-light-icon.png"
                  alt="Menu-icon"
                  loading="lazy"
                />
              </button>
