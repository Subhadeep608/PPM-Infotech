            ...
            <div className="col-lg-6 col-md-6 col-12">
              <div className="service-card service-light">
                <div>
                  ...
                  <p>
                    All websites are fully responsive with completely SEO
                    friendly & User friendly customized websites.
                  </p>
                </div>
            ...
            <div className="col-lg-6 col-md-6 col-12">
              <div className="service-card service-light">
                <div>
                  ...
                  <p>
                    We build fast, SEO-friendly & secure website also We build
                    fast, SEO-friendly & secure website.
                  </p>
                </div>
          ...
          <div className="row justify-content-between">
            ...
            <div className="col-lg-7 col-md-7 col-12 mb-4 mb-lg-0 home-about-right">
              ...
              <p className="desc mt-3">
                We integrate all APIs like SMS, Email or WhatsApp in your
                websites or applications for easy communications related to
                transactions & replies
              </p>
              ...
              <div className="row mt-4">
                <div className="col-sm-6">
                  <ul className="about-list">
                    ...
                    <li>
                      <i className="fa-solid fa-circle-check"></i>Speed &
                ...
                <div className="col-sm-6">
                  <ul className="about-list">
                    <li>
                      <i className="fa-solid fa-circle-check"></i> Focus on User
                      Experience (UX/UI)
                    </li>
                    <li>
                      <i className="fa-solid fa-circle-check"></i> Optimize for
                      SEO & Performance{" "}
                    </li>
                    <li>
                      <i className="fa-solid fa-circle-check"></i> Frontend
                      Development
                    </li>
                    <li>
