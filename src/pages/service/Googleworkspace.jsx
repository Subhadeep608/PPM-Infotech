        ...
        <div className="container-fluid">
          ...
          <div className="row price-area mt-4 price-card-col-4">
            ...
            <div className="pricing-card">
              ...
              <span className="pricing-beg">Save up to 10%</span>
            ...
            <div className="pricing-card">
              ...
              <ul className="price-feature-list py-3">
                ...
                <li className="inactive">
                  <i className="fa-regular fa-circle-check me-2 available"></i>
                  Chat with AI in the Gemini app with expanded access to models
                  and features
                </li>
                <li className="inactive">
                  <i className="fa-regular fa-circle-check me-2  available"></i>
                  Video meetings with recording, noise cancellation, 150
                  participants
                </li>
                <li className="inactive">
                  <i className="fa-regular fa-circle-check me-2 available"></i>
            ...
            <div className="pricing-card">
              ...
              <ul className="price-feature-list py-3">
                ...
                <li className="active">
                  <i className="fa-regular fa-circle-check me-2 available"></i>
                  Video meetings with in-domain live streaming, 1000
                  participants
                </li>
